...
// Payload -
type Payload struct {
	models.ClientLotModel
}

// SingleResponse -
type SingleResponse struct {
	ClientLot *models.ClientLotModel `json:"clientlot"`
	Lot       *models.LotModel       `json:"lot"`
}
...
func Routes(g *fiber.Group, db *mongo.Database) {
	...
	g.Post("/clientlots", func(c *fiber.Ctx) {
		log.Println("clientlots.post")
		var err error
		h.Ctx = c.Fasthttp
		h.User, h.Business, err = utils.PrepareHandler(c, h.DB)
		if err != nil {
