...
type ClientLotModel struct {
	...
	DownPayment float32             `bson:"downPayment" json:"downPayment" validate:"required,number,min=0"`
	Months      int                 `bson:"months" json:"months" validate:"required,number,min=0"`
	Monthly     float32             `bson:"monthly" json:"monthly" validate:"required,number,min=0"`
